...
pitch: "I built a pipeline that ships Bible reading plans on YouVersion in 1 second instead of 50 minutes - and turned those plans into a top-of-funnel acquisition channel that feeds HelloBible. 220 plans shipped, an undocumented API reverse-engineered, an entire publishing-to-acquisition loop automated."
