...
After losing half a day to the wrong stack, I stopped the N8N approach and switched to terminal-based Node.js scripts running on my Mac. The first end-to-end path worked about 20 minutes later.
