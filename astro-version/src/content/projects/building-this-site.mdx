...
If I redo this, I lock the visual direction earlier. I spent the first sessions trying three different aesthetics (clean Linear-style, editorial Substack-style, current Dark Forest) before committing. That cost me a few conversations with Claude.
